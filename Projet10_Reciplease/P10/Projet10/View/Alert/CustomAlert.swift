...
import Foundation
import UIKit
// custom alert to replace the ios one
final class CustomAlert {
    ...
    func showAlert(with title: String, message: String, on vc: UIViewController) {
        ...
        titleLabel.backgroundColor = UIColor(red: 0.38, green: 0.73, blue: 0.65, alpha: 1)
        ...
        button.backgroundColor = UIColor(red: 0.38, green: 0.73, blue: 0.65, alpha: 1)
